...
int main(void)
{
    ...
    do                          //This adds the digits that were not multiplied by 2
    {
        ...
        else //  If doubled is not more than 10, it just adds the number to the sum
        {
            multi = doubled + multi;
        }
    ...
    if (sum % 10 == 0)
    {
        ...
        //  MASTERCARD: 16 digits, Starts with 51, 52, 53, 54, or 55
                 ...
                 && (startingnumber / 100000000000000 == 51 | startingnumber /  100000000000000 == 52 | startingnumber /  100000000000000 == 53 |
