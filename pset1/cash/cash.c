...
int main(void)
{
    ...
    do // Loops as long as remainder is more than zero. If the condition is true, it executes the code inside the block before starting the loop again. If a condition is true, it will not check the other if-statements.
    {
